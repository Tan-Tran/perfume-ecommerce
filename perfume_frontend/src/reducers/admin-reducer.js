import {
  ...
  ADMIN_UPDATE_USER_INFO_SUCCESS,
  ADMIN_UPDATE_USER_INFO_FAILURE,
  FORM_RESET,
...
const reducer = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case ADMIN_UPDATE_USER_INFO_SUCCESS:
      return { ...state, success: true, user: payload };

    case ADMIN_UPDATE_USER_INFO_FAILURE:
      return { ...state, success: false, errors: payload };
